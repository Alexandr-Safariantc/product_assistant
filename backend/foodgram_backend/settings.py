...
INGREDIENT_NAME_MEASURE_MAX_LENGTH = 200
...
SUPERUSER_CREATE_SUCCESS = 'Superuser has been successfully created'
SUPERUSER_EXISTS_WARNING = 'Superuser already exists'
